...
// Layout a row that fills up all horizontal and vertical space
void Layout_All(struct nk_context*);

// Layout a row with a column that fills up all horizontal space
