...
STYLE_ITEM_PAIR Style_Item_Pair_Color_Uniform(struct nk_color, struct nk_color);
STYLE_ITEM_PAIR Style_Item_Pair_Color_Autodiff(struct nk_color);
STYLE_ITEM_PAIR Style_Item_Pair_Color_Diff(
struct nk_color, COLOR_DIFF_RULE, uint8_t diff);
STYLE_ITEM_PAIR Style_Item_Pair_Color(struct nk_color, struct nk_color);
...
STYLE_ITEM_TRIO Style_Item_Trio_Color_Uniform(
struct nk_color, struct nk_color, struct nk_color);
STYLE_ITEM_TRIO Style_Item_Trio_Color_Autodiff(struct nk_color);
STYLE_ITEM_TRIO Style_Item_Trio_Color_Diff(
struct nk_color, COLOR_DIFF_RULE, uint8_t diff);
STYLE_ITEM_TRIO Style_Item_Trio_Color(
struct nk_color, struct nk_color, struct nk_color);
...
COLOR_PAIR Color_Pair_Diff(struct nk_color, COLOR_DIFF_RULE, uint8_t diff);
...
COLOR_TRIO Color_Trio_Diff(struct nk_color, COLOR_DIFF_RULE, uint8_t diff);
