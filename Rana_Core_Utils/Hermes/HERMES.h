...
#define HERMES_VIDEO_INIT	(HERMES_TYPE){"themis", NETWORK_TYPE_TCP, 10}
#define HERMES_KEYBOARD		(HERMES_TYPE){"themis", NETWORK_TYPE_UDP, 11}
#define HERMES_MOUSE		(HERMES_TYPE){"themis", NETWORK_TYPE_UDP, 12}
