...
#define HERMES_AUDIO_WS		(HERMES_TYPE){"audio_ws", NETWORK_TYPE_WS, 13}
#define HERMES_VIDEO_WS		(HERMES_TYPE){"video_ws", NETWORK_TYPE_WS, 14}
#define HERMES_DEVICE_WS	(HERMES_TYPE){"device_ws", NETWORK_TYPE_WS, 15}

#define HERMES_CLIENT_TCP	(HERMES_TYPE){"hermes_client_tcp", NETWORK_TYPE_TCP, 16}
#define HERMES_CLIENT_WS	(HERMES_TYPE){"hermes_client_ws", NETWORK_TYPE_WS, 17}
#define HERMES_SERVER_TCP	(HERMES_TYPE){"hermes_server_tcp", NETWORK_TYPE_TCP, 18}
#define HERMES_SERVER_WS	(HERMES_TYPE){"hermes_server_ws", NETWORK_TYPE_WS, 19}
