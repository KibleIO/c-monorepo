...
#define HERMES_AUDIO_WS		(HERMES_TYPE){"audio_ws", NETWORK_TYPE_WS, 15}
#define HERMES_VIDEO_WS		(HERMES_TYPE){"video_ws", NETWORK_TYPE_WS, 16}
#define HERMES_DEVICE_WS	(HERMES_TYPE){"device_ws", NETWORK_TYPE_WS, 17}
