...
{
	Remove_Callback_Block_Event(calling_block->On_Unemploy, Unemploy_Gaia_Root_Remote_Actor);
	Remove_Callback_Block_Event(calling_block->On_Commit  , Commit_Gaia_Root_Remote_Actor  );
